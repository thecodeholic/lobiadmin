...
//            me.$options.controls = {};
            ...
            me.$options.minWidth = me.$el.attr('data-min-width') || $.fn.lobiPanel.DEFAULTS.minWidth;
            me.$options.maxWidth = me.$el.attr('data-max-width') || $.fn.lobiPanel.DEFAULTS.maxWidth;
            me.$options.minHeight = me.$el.attr('data-min-height') || $.fn.lobiPanel.DEFAULTS.minHeight;
            me.$options.maxHeight = me.$el.attr('data-max-height') || $.fn.lobiPanel.DEFAULTS.maxHeight;
            
            if (me.$el.attr('data-draggable') === undefined){
                me.$options.draggable = $.fn.lobiPanel.DEFAULTS.draggable;
            }
            ...
            me.$options.loadUrl = me.$el.attr('data-load-url') || $.fn.lobiPanel.DEFAULTS.loadUrl;
            me.$options.resize = me.$el.attr('data-resize') || $.fn.lobiPanel.DEFAULTS.resize;
        };
